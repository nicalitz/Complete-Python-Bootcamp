'''
Text based blackjack game. Should still implement double down and split
'''
...
class Hand(object):
    ...
    def show_hand(self,dealer):
        if not dealer:
            print("{} hand:".format(self.name),self.cards,'which adds up to',self.score())
        else:
            print("{} hand:".format(self.name),self.cards[0])
